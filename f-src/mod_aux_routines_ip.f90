...
SUBROUTINE TD_Array_Scatter (size_mpi, sections)
  ...
  CASE(3);     sections = (/  3,  1,  1 /) ! Not recommended. But implementing it prevents crashing :)
  CASE(4);     sections = (/  2,  2,  1 /)
  CASE(5);     sections = (/  5,  1,  1 /) ! Not recommended. But implementing it prevents crashing :)
  CASE(6);     sections = (/  3,  2,  1 /)
  CASE(7);     sections = (/  7,  2,  1 /) ! Not recommended. But implementing it prevents crashing :)
